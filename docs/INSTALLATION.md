...
dependencies {
    implementation("com.github.Braidrun:braidrun-workflow:1.0.9")
}
```
...
This publishes `com.fartech.braidrun:braidrun-workflow:1.0.9` to `~/.m2`. Add `mavenLocal()` to your repositories and depend on that coordinate.

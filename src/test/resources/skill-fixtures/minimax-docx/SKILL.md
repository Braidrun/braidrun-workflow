...
translations:
  zh:
    name: "MiniMax DOCX"
    description: >-
      使用 MiniMax 文档能力打开、创建、读取、分析、编辑或验证 Word/.docx 文档。适用于文档生成、内容抽取、格式处理、报告和专业文档交付。
  en:
    name: "MiniMax DOCX"
    description: >-
      Open, create, read, analyze, edit, or validate Word/.docx documents with MiniMax document capabilities. Use for document generation, content extraction, formatting, reports, and professional document deliverables.
  zhHant:
    name: "MiniMax DOCX"
    description: >-
      使用 MiniMax 文件功能開啟、建立、讀取、分析、編輯或驗證 Word/.docx 文件。用於文件產生、內容擷取、格式處理、報告和專業文件交付成果。
  ja:
    name: "MiniMax DOCX"
    description: >-
      MiniMax の文書機能で Word/.docx 文書を開く、作成する、読む、分析する、編集する、検証する場合に使用します。文書生成、内容抽出、書式処理、レポート、専門的な文書成果物に適しています。
  ko:
    name: "MiniMax DOCX"
    description: >-
      MiniMax 문서 기능을 사용하여 Word/.docx 문서를 열고, 생성하고, 읽고, 분석하고, 편집하거나 검증합니다. 문서 생성, 콘텐츠 추출, 서식 지정, 보고서 및 전문 문서 결과물에 사용합니다.
  es:
    name: "MiniMax DOCX"
    description: >-
      Abre, crea, lee, analiza, edita o valida documentos Word/.docx con las funciones de documentos de MiniMax. Úsalo para generar documentos, extraer contenido, aplicar formato, crear informes y producir entregables profesionales.
  fr:
    name: "MiniMax DOCX"
    description: >-
      Ouvrez, créez, lisez, analysez, modifiez ou validez des documents Word/.docx avec les fonctionnalités documentaires de MiniMax. À utiliser pour la génération de documents, l'extraction de contenu, la mise en forme, les rapports et les livrables documentaires professionnels.
  de:
    name: "MiniMax DOCX"
    description: >-
      Word-/DOCX-Dokumente mit den Dokumentfunktionen von MiniMax öffnen, erstellen, lesen, analysieren, bearbeiten oder validieren. Verwenden für Dokumenterstellung, Inhaltsextraktion, Formatierung, Berichte und professionelle Dokumentergebnisse.
  vi:
    name: "MiniMax DOCX"
    description: >-
      Mở, tạo, đọc, phân tích, chỉnh sửa hoặc xác thực tài liệu Word/.docx bằng các khả năng xử lý tài liệu của MiniMax. Sử dụng để tạo tài liệu, trích xuất nội dung, định dạng, làm báo cáo và cung cấp tài liệu chuyên nghiệp.
  ar:
    name: "MiniMax DOCX"
    description: >-
      افتح مستندات Word/.docx أو أنشئها أو اقرأها أو حللها أو حررها أو تحقق منها باستخدام إمكانات المستندات في MiniMax. يُستخدم لإنشاء المستندات واستخراج المحتوى والتنسيق والتقارير ومخرجات المستندات الاحترافية.
  pt:
    name: "MiniMax DOCX"
    description: >-
      Abra, crie, leia, analise, edite ou valide documentos Word/.docx com as funcionalidades de documentos do MiniMax. Utilize para gerar documentos, extrair conteúdo, formatar, criar relatórios e produzir materiais documentais profissionais.
name: minimax-docx
description: >
